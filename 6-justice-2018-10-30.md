...
I kinda feel like there's a way that Tuck and Yang are a response, or a conversation, about how ....colonial temporality.
...
- dcwalk: Can I invite you to talk about what you just put in the chat?

Eric: This was just one of the quotesthe Tuck and Yang aritcle
...
I think they're getting at thisan obscure prospective, but their point about -- the person that takes it[X] -- derives their powerwhen you get to make exceptions to the rules. Because the state gets to decide when to make the exception, they can also decide who is excludednotions of justice. So, I think that's the connection between the two readings.

[Seong -- I you may want to edit what I wrote -- you said it better ^.^]
...
00:19:48	Matt Price:	thx for the heroic notetaking mHz. thoughtI was gonna be helping but... :-(
...
00:32:31	Jeremy Cahill:	maybe tangentially related to the "unholy" confluence description from - Matt P: the recent discussion around this newyorker article
https://www.google.com/search?q=can+economists+and+humanists+ever+be+friends
...
01:23:19	Matt Price:	I know so little about blockchain. But the view of what society is, and what people are, that bitcoin seems to have, is, from what I can see, kind of anhorrent. 
